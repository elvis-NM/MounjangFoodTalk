...
namespace MounjangFoodTalk.ServiceLayer
{
    public interface IUsersService
    {
        ...
        void UpdatedUserDetails(EditUserDetailsViewModel uvm);
        void UpdatedUserPassword(EditUserPasswordViewModel uvm);
    ...
    public class UsersService : IUsersService
    {
        ...
        private readonly IUsersRepository ur;
        ...
        public void UpdatedUserDetails(EditUserDetailsViewModel uvm)
        {
            var config = new MapperConfiguration(cfg =>
            {
                cfg.CreateMap<EditUserDetailsViewModel, User>(); cfg.ignoreUnmapped();
            });
            IMapper mapper = config.CreateMapper();
        ...
        public void UpdatedUserPassword(EditUserPasswordViewModel uvm)
        {
            var config = new MapperConfiguration(cfg =>
            {
                cfg.CreateMap<EditUserPasswordViewModel, User>(); cfg.ignoreUnmapped();
            });
            IMapper mapper = config.CreateMapper();
        ...
        public List<UserViewModel> GetUsers()
        {
            ...
            var config = new MapperConfiguration(cfg =>
            {
                cfg.CreateMap<UserViewModel, User>(); cfg.ignoreUnmapped();
            });
            IMapper mapper = config.CreateMapper();
